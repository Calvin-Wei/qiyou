...
public class PullToRefreshView extends ViewGroup {
	...
	private static final int DRAG_MAX_DISTANCE = 120;// 最大距离
	...
	public boolean onTouchEvent(@NonNull MotionEvent ev) {
		...
		case MotionEvent.ACTION_MOVE: {
			...
			float boundedDragPercent = Math.min(1f,
					Math.abs(mCurrentDragPercent));
	...
	private void animateOffsetToPosition(Animation animation) {
		...
		long animationDuration = (long) Math.abs(MAX_OFFSET_ANIMATION_DURATION
				* mFromDragPercent);
	...
	private final Animation mAnimateToCorrectPosition = new Animation() {
		...
		public void applyTransformation(float interpolatedTime,
			...
			mCurrentDragPercent = mFromDragPercent - (mFromDragPercent - 1.0f)
					* interpolatedTime;
			mRefreshView.setPercent(mCurrentDragPercent);
	...
	protected void onLayout(boolean changed, int l, int t, int r, int b) {
		...
		mRefreshImageView.layout(left, top, left + width - right, top + height
				- bottom);
	}
