 ...
 * @category 购买机票
 */
public class PlaneActivity extends Activity implements OnItemClickListener,
		OnClickListener {
	...
	private int[] resId = { R.drawable.plane_pic };
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.buy_plane);
		// 得到保存的收藏信息
		getSaveCollection();
		initView();
	...
	private void initView() {
		...
		all_choice_layout = (LinearLayout) findViewById(R.id.plane_all_choice_layout);
		initViewPager();
		// 如果当前景点已经收藏，显示收藏后的效果
		if (isCollection) {
	...
	private void initViewPager() {
		...
		viewPager = (HackyViewPager) findViewById(R.id.iv_plane);
	...
	public void onClick(View v) {
		switch (v.getId()) {
		case R.id.plane_iv_back:
			finish();
			break;
		case R.id.iv_plane_collection:
			// 收藏
			if (isCollection) {
				// 提示是否取消收藏
				cancelCollection();
